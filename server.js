...
async function createBrandedImageAI(imageBuffer, captionText, withModel = false) {
  ...
  const bgPrompt = withModel
    ? `You are generating a high-resolution photograph — not an illustration, not a render, not AI art. The final image must be completely indistinguishable from a real professional photo taken on a camera.

Using this product photo as reference, produce a photographic image of a real woman wearing this exact jewelry piece:

WOMAN:
- Medium-length dark hair loosely tied back, with natural fly-aways and texture — not perfect
- Minimal natural makeup: light foundation, subtle brow, maybe a soft lip — no glam, no filters
- Expression: confident and relaxed, slight natural smile or calm neutral look — candid, not posed
- Skin has natural texture — pores, subtle imperfections, no airbrushing, no plastic smoothing
- Features are balanced and soft — she looks like a real person you'd pass on the street in Miami
- Age 25-38, relatable and approachable, not a supermodel — think friend, not runway
- Body language is relaxed and natural, not stiff
...
- Clearly visible and well-lit — the jewelry is the star

PHOTO QUALITY:
- Shot on a high-end camera — natural depth of field, realistic bokeh, natural grain
- Lighting: soft natural light or warm studio light — realistic shadows, no harsh flash
- Background: real environment that complements the jewelry — warm tones, soft blur
- Colors are natural and true-to-life — not oversaturated, not filtered
- The image must look like it was taken by a professional photographer, not generated by AI

Output: square 1:1 format, ultra-photorealistic, no text, no watermarks, no AI artifacts`
